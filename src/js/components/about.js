...
const About = () => {
    return (
      <div className="main container">
        <h3 className="title"> Why I began homebrewing </h3>
        <p>
          ...
          Although there are German books about brewing, I started reading <a class="bold" target="_blank" href="http://howtobrew.com/intro.html">How to Brew</a>
